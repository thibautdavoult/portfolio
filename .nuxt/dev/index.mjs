...
import { createStorage, prefixStorage } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/unstorage/dist/index.mjs';
...
import { Youch } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/source-map/source-map.js';
...
const _h9Tvi9qrjnCRynxuKWx6staSCtTi6PWUyqrGXISyyMM = (nitroApp) => {
...
const plugins = [
  _h9Tvi9qrjnCRynxuKWx6staSCtTi6PWUyqrGXISyyMM,
_UdWGHHGAa7R9BM923do3Jws9jtPcKA6pFIMAos7lxQY
];

const _lazy_JBraCz = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_JBraCz, lazy: true, middleware: false, method: undefined },
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/thibautdavoult/code/perso/portfolio/.data/kv"}));
...
const getClientManifest = () => import('file:///Users/thibautdavoult/code/perso/portfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/thibautdavoult/code/perso/portfolio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
