import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineComponent, h, resolveComponent, computed, provide, watch, Suspense, Fragment, useSSRContext, mergeProps, withCtx, createTextVNode, defineAsyncComponent, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/vue/index.mjs';
import { createHooks } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/h3/dist/index.mjs';
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/vue-router/dist/vue-router.node.mjs';
...
import { defu } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/defu/dist/defu.mjs';
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/ufo/dist/index.mjs';
import { u as useHead$1, h as headSymbol } from '../_/renderer.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/thibautdavoult/code/perso/portfolio/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#FAF9F6]" }, _attrs))}><div class="max-w-[700px] mx-auto px-6"><header class="py-12"><nav class="flex justify-between items-center">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "text-[#1a5f7a] font-medium hover:underline transition-all duration-200"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Thibaut Davoult`);
      } else {
        return [
          createTextVNode("Thibaut Davoult")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/about",
    class: "text-[#1a5f7a] hover:underline transition-all duration-200"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`About`);
...
export { _export_sfc as _, __nuxt_component_0 as a, server as s, useHead as u };
